...
# Title: Top Block
# Generated: Tue Apr 25 10:49:46 2017
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.freq = freq = 459000000
        self.baud_rate = baud_rate = 400000
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/ecestudent/SENIOR PROJECT/fec testing/images/kermit_enc.png', False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/ecestudent/Documents/gnu_radio_testing/kermit_out1.png', False)
        ...
        self.connect((self.blocks_file_source_1, 0), (self.wxgui_fftsink2_0_1, 0))
