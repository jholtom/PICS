...
#if defined(__FUZZ__)
  // do no work. We don't emulate transmission for fuzzing
#else
#error "Only fuzzing is supported"
#endif
  callback(i2cp, txbuf, n);
}
...
#if POSIX_I2C_USE_I2C1 == TRUE
    if (&I2CD1 == i2cp) {
      chDbgAssert(0, "I2C support not implemented");
    }
#endif
  }
