...
void elyTelemPostBufferS(uint8_t * buff, telemcallback_t cb) {
  ...
  /* TODO Timeout for safety - right now, if FRAM can't be allocated and the semaphore
   * doesn't drop, it'll spin forever and never exit...maybe decrease timeout and
   * catch the failure somehow
   * */
