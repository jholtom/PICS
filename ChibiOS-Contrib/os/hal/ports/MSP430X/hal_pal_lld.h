...
#undef PAL_MODE_OUTPUT_OPENDRAIN /* no open-drain drivers */
#undef PAL_EVEN_MODE_BOTH_EDGES /* no double-edged interrupts */
...
#define PAL_LINE(port, pad)                                                    \
  ((ioline_t)((uintptr_t)(port)) | (((uintptr_t)(pad)) << 12))

/**
 * @brief   Decodes a port identifier from a line identifier.
 */
#define PAL_PORT(line)                                                         \
  ((msp430x_gpio_registers_t *)(((uintptr_t)(line)) & 0x0FFFU))

/**
 * @brief   Decodes a pad identifier from a line identifier.
 */
#define PAL_PAD(line) ((uint16_t)((uintptr_t)(line) >> 12))
 ...
 */
typedef volatile msp430x_gpio_registers_t * ioportid_t;
 ...
 */
#if defined(PA_BASE) || defined(__DOXYGEN__)
#define IOPORT1 ((msp430x_gpio_registers_t *)PA_BASE)
#endif
 ...
 */
#if defined(PB_BASE) || defined(__DOXYGEN__)
#define IOPORT2 ((msp430x_gpio_registers_t *)PB_BASE)
#endif
 ...
 */
#if defined(PC_BASE) || defined(__DOXYGEN__)
#define IOPORT3 ((msp430x_gpio_registers_t *)PC_BASE)
#endif
 ...
 */
#if defined(PD_BASE) || defined(__DOXYGEN__)
#define IOPORT4 ((msp430x_gpio_registers_t *)PD_BASE)
#endif
 ...
 */
#if defined(PE_BASE) || defined(__DOXYGEN__)
#define IOPORT5 ((msp430x_gpio_registers_t *)PE_BASE)
#endif
 ...
 */
#if defined(PF_BASE) || defined(__DOXYGEN__)
#define IOPORT6   ((msp430x_gpio_registers_t *)PF_BASE
#endif

/**
 * @brief   GPIO port J identifier.
 */
#define IOPORT0 ((msp430x_gpio_registers_t *)PJ_BASE)
 ...
 * @note    NULL callbacks are not permitted in this implementation.
 * @note    Programming an unknown or unsupported mode is silently ignored.
 *
 * @param[in] port      port identifier
...
#define pal_lld_enablepadevent(port, pad, mode, callback)                     \
  _pal_lld_enablepadevent(port, pad, mode, callback)
