...
PLATFORMSRC = ${CHIBIOS_CONTRIB}/os/hal/ports/MSP430X/hal_lld.c \
              ...
              ${CHIBIOS_CONTRIB}/os/hal/ports/MSP430X/hal_i2c_lld.c \
              ${CHIBIOS_CONTRIB}/os/hal/ports/MSP430X/hal_uart_lld.c \
              ${CHIBIOS_CONTRIB}/os/hal/ports/MSP430X/hal_gpt_lld.c \
